...
public class UsersController  {
	...
	@PostMapping("/admin/users/save")//Spring MVC注解，指定处理POST请求的路径。

	public JsonResult save() {//方法声明，返回类型为JsonResult，意味着该方法将返回一个JSON格式的结果。
		String username = request.getParameter("username");//通过request对象获取名为"username"的参数值，并将其存储在username变量中。
